...
namespace SLIRPWrapper
{
    public static class InterOpUtility
    {
        ...
        [DllImport("OpenGLCudaInterOp", CallingConvention = CallingConvention.Cdecl, EntryPoint = "disableGLDebug")]
        public extern static void DisableGLDebug();
        ...
        [DllImport("OpenGLCudaInterOp", CallingConvention = CallingConvention.Cdecl, EntryPoint = "getGLDevices")]
        public extern static void GetGLDevices(out uint pCudaDeviceCount, out int pCudaDevices, uint cudaDeviceCount);
